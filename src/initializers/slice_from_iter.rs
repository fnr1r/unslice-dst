...
use super::{InitSlice, InitSliceCan, init_slice_upcast};
use crate::utils::slice::slice_assume_init_mut;
...
#[inline]
pub(crate) fn write_slice_iter_fn_can<T>(
...
#[inline]
pub(crate) fn write_slice_iter_fn<T>(value: impl ExactSizeIterator<Item = T>) -> impl InitSlice<T> {
    init_slice_upcast(write_slice_iter_fn_can(value))
}
